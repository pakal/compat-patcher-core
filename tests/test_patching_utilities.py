...
def test_patch_injected_objects_setting():
    ...
    patching_utilities.apply_config(dict(patch_injected_objects="myattrname"))
    ...
    patching_utilities.apply_config(dict(patch_injected_objects=False))
...
def test_enable_warnings_setting():
    ...
    patching_utilities.apply_config(dict(enable_warnings=False))
...
def test_logging_level_setting(capsys):
    ...
    patching_utilities.apply_config(dict(logging_level=None))
    ...
    patching_utilities.apply_config(dict(logging_level="DEBUG"))
